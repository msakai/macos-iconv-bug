...
I noticed this problem by the CI failure of the bytestring-encoding package I am developing for Haskell ([issue](https://github.com/msakai/bytestring-encoding/issues/15)).
