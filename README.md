# `iconv()` bug on macOS 14 (Sonoma) and 15 (Sequoia), fixed in macOS 26 (Tahoe)
...
**This bug has been fixed in macOS 26 (Tahoe)**, which ships [`libiconv-113`](https://github.com/apple-oss-distributions/libiconv/tree/libiconv-113); the test program outputs the expected bytes there again. See the [Root cause](#root-cause) section below for the analysis.
